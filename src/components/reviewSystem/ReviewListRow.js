  ...
  render() {
    ...
    return (
      <div className="review-container">
        {canDelete &&
          <button type="button" onClick={() => {if(confirm(`Delete this review by ${review.Username}?`)) {this.deleteReview();}}} id={`btnDeleteReview_${index}`} className="btn btn--delete-review" ><i className="fa fa-times" /></button>
        }
